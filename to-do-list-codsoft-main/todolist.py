...
Heading=Label(text="ToDo List",bg="yellow",fg="black",font="comicsansms 30 bold")
...
entry=Button(todolist,text="Add task",command=enter,borderwidth=2,bg="black",fg="white",font="comicsansms 10")
entry.pack(side=LEFT,padx=5)
delete=Button(todolist,text="Delete selected task",command=dele,borderwidth=2,bg="black",fg="white",font="comicsansms 10")
delete.pack(side=LEFT,padx=5)
complete=Button(todolist,text="Mark as completed",command=complete,borderwidth=2,bg="black",fg="white",font="comicsansms 10")
